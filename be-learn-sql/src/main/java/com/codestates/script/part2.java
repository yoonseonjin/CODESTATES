...
public class part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO user(name, email) VALUES ('윤선진', 'xeccior@gmail.com');";
  ...
  */
  public static final String PART2_7 = "SELECT content.title, user.name FROM content LEFT JOIN user ON content.userID = user.id;";
  ...
  */
  public static final String PART2_8 = "SELECT content.title, user.name FROM content JOIN user ON content.userId = user.id;";
  ...
  */
  public static final String PART2_10 = "INSERT INTO content (title, body, userId) VALUES ('제목', '본문', '1');";
}
